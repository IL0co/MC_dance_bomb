...
public void OnPluginStart()
{
	...
	g_VipCookie = new Cookie(VIP_FEATURE, VIP_FEATURE, CookieAccess_Private);
...
public void VIP_OnVIPLoaded()
{
	...
	VIP_RegisterFeature(VIP_FEATURE, STRING, SELECTABLE, CallBack_VIP_OnItemSelected, CallBack_VIP_OnItemDisplayed);
}
